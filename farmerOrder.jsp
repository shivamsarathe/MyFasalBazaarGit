	...
	<body>
		...
		<!-- Container 2 Start -->
			<div class="container-fluid cardcar2">
				...
				<c:forEach var="shippingAdd" items="${shippingAddress}">

					<div class="col-md-3">
						<div class="card img-hover">
						<img class="card-img-top img-responsive" src="crop_pic.do?picPath=${shippingAdd.commodity.commodityPics.picPath}" alt="Card image" style="height:200px;width:330px">
							<div class="card-body">
